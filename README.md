...
Crypt Server supports API key authentication for the `/checkin/` and `/verify/` endpoints.
...
If `CRYPT_API_KEY` is not set, endpoints remain open for backward compatibility.
